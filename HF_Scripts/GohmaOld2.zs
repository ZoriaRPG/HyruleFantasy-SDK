			...
			if (GohmaCounter <= 0)
			{
				...
				while ((LaserY < 144 && LaserX > 32 && LaserX < 224) || (LaserY2[29] < 144 && LaserX2[29] > 32 && LaserX2[29] < 224) || (LaserY3[29] < 144 && LaserX3[29] > 32 && LaserX3[29] < 224))
				{
					...
					if (LaserY < 144 && LaserX > 32 && LaserX < 224)
					{
						if (BoomCounter == 3)
						{
							eweapon Hey = FireAimedEWeapon(EW_FIRE, LaserX - 8, LaserY - 8, 0, 0, 0, 80, 0, EWF_NO_COLLISION);
							SetEWeaponLifespan(Hey, EWL_TIMER, 30);
							SetEWeaponDeathEffect(Hey, EWD_SBOMB_EXPLODE, ghost->WeaponDamage * 2);
						}
					...
					if (LaserY2[29] < 144 && LaserX2[29] > 32 && LaserX2[29] < 224)
					{
						...
						if (WaitCounter <= 0)
						{
							if (BoomCounter == 3)
							{
								eweapon Hey = FireAimedEWeapon(EW_FIRE, LaserX2[29] - 8, LaserY2[29] - 8, 0, 0, 0, 80, 0, EWF_NO_COLLISION);
								SetEWeaponLifespan(Hey, EWL_TIMER, 30);
								SetEWeaponDeathEffect(Hey, EWD_SBOMB_EXPLODE, ghost->WeaponDamage * 2);
							}
							if (BoomCounter%2 == 0)
					...
					if (LaserY3[29] < 144 && LaserX3[29] > 32 && LaserX3[29] < 224)
					{
						...
						if (WaitCounter <= 0)
						{
							if (BoomCounter == 3)
							{
								eweapon Hey = FireAimedEWeapon(EW_FIRE, LaserX3[29] - 8, LaserY3[29] - 8, 0, 0, 0, 80, 0, EWF_NO_COLLISION);
								SetEWeaponLifespan(Hey, EWL_TIMER, 30);
								SetEWeaponDeathEffect(Hey, EWD_SBOMB_EXPLODE, ghost->WeaponDamage * 2);
							}
							if (BoomCounter%2 == 0)
