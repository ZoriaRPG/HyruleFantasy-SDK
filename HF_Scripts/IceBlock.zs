...
const int ICE_BLOCK_SCRIPT = 84; // Slot number that the ice_block script is assigned to
const int ICE_BLOCK_SENSITIVITY = 15; // Number of frames the blocks need to be pushed against to start moving
